...
public class TrailerAdapter extends RecyclerView.Adapter<TrailerAdapter.TrailerViewHolder> {
    ...
    public TrailerViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        // TrailerViewHolder created and connected to the trailer_list_item.xml layout
    ...
    public String[] extractTrailerUrls (List<Trailer> trailerResults){
        Log.i(LOG_TAG, "extractTrailerUrls() method callled...");

        // Create a String[] array with a length equal to the size of the List of Movies
        String[] trailerUrls = new String[trailerResults.size()];
        int index = 0;
        for(Trailer t : trailerResults){
            trailerUrls[index] = (String) t.getTrailerKey();
            index++;
        }
        return trailerUrls;
    }
